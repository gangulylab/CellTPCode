...
% Factor analysis averaged over 10 random subsets of dim_in columns of x_in.
% Returns the mean loadings, specific variances, rotation, and factor scores.
% See rnd_FA_mean2 for the single-draw version.
    for i = 1:10
