function Mdata_comb = comb4depth_v2(Mdata_app,size_in)
% Pool cell depth, index, modulation flag, and per-bin modulation across
% animals for each session. Depth is converted from pixels to microns.
    um_x   = 950/1280;
    um_y   = 600/800;
